...
class Calculator extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    // Criação do Widget
    return Scaffold(
      // return do Scaffold para estilização
      appBar: AppBar(
        // criação da appBar
        ...
        leading: IconButton(
          ...
          onPressed: () {
            // função para fazer algo se for pressionado
      ...
      body: Container(
          ...
          child: Align(
            ...
            child: Container(
              //criação do retangulo para os botões
              ...
              decoration: BoxDecoration(
                // caixa de decoração
                borderRadius:
                    BorderRadius.circular(10.0), // bordas arredendadas
                border: Border.all(
                  // borda do retangulo
